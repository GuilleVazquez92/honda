      ...
      <div class="container">
        <div class="row office-list">
          ...
          <div class="col-12 d-none d-md-block d-lg-block d-xl-block">
            <div id="service-map" class="map"></div>
          </div>
...
export default {
  ...
  computed: {
    title() {
      return this.$parent.content['service'] ? this.$parent.content['service'].title : ''
    },
    content() {
      return this.$parent.content['service'] ? this.$parent.content['service'].content : ''
    },
    offices() {
      return this.$parent.garages;
    },
  },
  methods: {
