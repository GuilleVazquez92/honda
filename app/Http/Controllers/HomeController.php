...
class HomeController extends Controller
{
    ...
    public function data() {
        ...
        foreach ($products as $i=>$v):
            ...
            if (!empty($products[$i]['pricing'][0]->field))
            {
            ...
            if (!empty($products[$i]['pricing'][2]->value))
            {
    ...
    public function budgets(Request $request) {
        ...
        //     ]);
            ...
            'product_of_interest' => 'Moto',
            'contact_method' => 'email',
            'contact_value' => 'guillevaz92@gmail.com',
            'message' =>'Prueba'
            ]);
            ...
            if ($office != null && $office->email != null && strlen($office->email) > 0) {
                ...
                Mail::to('guillevaz92@gmail.com')->send(new PilotEmail($data));
            }
